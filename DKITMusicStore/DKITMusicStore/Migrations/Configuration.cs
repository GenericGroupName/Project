namespace DKITMusicStore.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DKITMusicStore.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(DKITMusicStore.Models.ApplicationDbContext Dbcontext)
        {
            ...
            genres.ForEach(g => Dbcontext.Genres.AddOrUpdate(g));
            ...
            artists.ForEach(a => Dbcontext.Artists.AddOrUpdate(a));
            Dbcontext.SaveChanges();
            ...
            al.ForEach(alb => Dbcontext.Albums.AddOrUpdate(alb));
            Dbcontext.SaveChanges();
            ...
            //if (Dbcontext == null)
            //{
            //    throw new ArgumentNullException("Dbcontext", "Context must not be null.");
            //}
            ...
            if (!Dbcontext.Users.Any(u => u.UserName == "Admin@here.com"))
            {
                var store = new UserStore<ApplicationUser>(Dbcontext);
                var manager = new UserManager<ApplicationUser>(store);
                var user = new ApplicationUser { UserName = "Admin@here.com", Email = "Admin@here.com" };
